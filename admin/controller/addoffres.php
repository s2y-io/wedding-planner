...
if(isset($_POST["submit"])) {
    ...
    //if($check !== false) {
		...
		mysqli_query($connection, "INSERT INTO magazineadd(magno, regdate, imagepath, delflag) VALUES('".$title1."','".$veregdate."','".$target_file."','0')");
		echo "<script>
		alert('Magazine added Successfuly');
		window.location.href='../admin-dashboard-add-magazine.php';
		</script>";  
}
?>