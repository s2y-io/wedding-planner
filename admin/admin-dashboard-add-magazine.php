    ...
    <div class="dashboard-wrapper">
        ...
        <div class="dashboard-content">
            <div class="container">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="../admin/controller/addmag.php" method="post" enctype="multipart/form-data">
                            <!-- Form Name -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label class="control-label" for="catename">Magazine Page No</label>
                            ...
                            <div class="dashboard-venue-gallery">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <!-- File Button -->
                                        <div class="form-group">
                                            <label class="control-label" for="filebutton">Browse Image(410x512)</label>
